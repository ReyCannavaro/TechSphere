...
<nav class="navbar">
    ...
    <!-- Navigation Links -->
    <ul class="nav-links">
        <li><b><a href="<?php echo e(route('home')); ?>">Home</a></b></li>
        <li><b><a href="<?php echo e(route('gadgets')); ?>">Gadgets</a></b></li>
...
</html><?php /**PATH /home/reycannavaro/TechSphere/resources/views/user/home.blade.php ENDPATH**/ ?>